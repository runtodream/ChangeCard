...
public class FullscreenActivity extends AppCompatActivity implements SensorEventListener
    ...
    private void toggle() {
        mContentView.setImageDrawable(this.getResources().getDrawable(R.drawable.blue_card));
        /*if (mVisible) {
            hide();
        } else {
            show();
    ...
    public void onSensorChanged(SensorEvent sensorEvent) {
        float dbDistance = sensorEvent.values[0];
        Log.d( "kgw", "distance(" + dbDistance + ")" );
        if(dbDistance < 8.0) {
            mContentView.setImageDrawable(this.getResources().getDrawable(R.drawable.red_card));
        }
        /*
        if(dbDistance < 8.0 && mUpdateEnable) {
            mIsBlue = !mIsBlue;
            if(mIsBlue) {
                mContentView.setImageDrawable(this.getResources().getDrawable(R.drawable.blue_card));
            } else {
